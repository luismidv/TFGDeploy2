  ...
  return (
        ...
        <div>
          <div className="top-container p-6 rounded-lg shadow-lg flex flex-wrap items-center justify-between">
            ...
            <img className="mainlogo absolute left-[100px] md:left-[330px] top-[-50px]" src={companyImage} alt="Company Logo" />
            <p className="pslogan text-center hidden md:block ">Improving your house sharing experience</p>
    
               <div className="menu-div justify-center grid grid-cols-2 md:grid-cols-4 relative left-[20px] md:left-[330px]">
          ...
          <section className="recomendations max-w-[700px] w-full md:text-left absolute left-[120px] top-[330px] md:left-[420px] ">
