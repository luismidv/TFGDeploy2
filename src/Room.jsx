...
export function RoomBannerTenants({label, img, rooms, metters, bathrooms,price, bedroomsvg, 
    ...
    return(
        <div className = "room-label lg:w-[800px] lg:h-[500px] md:w-[800px] md:h-[500px] w-[500px] h-[100px] left-[205px] top-[-100px] lg:left-[200px] md:left-[200px] md:top-[100px] mb-300 md:mb-0">
